...
OBJECTS += ./Adafruit_GFX/Adafruit_GFX.o
OBJECTS += ./Adafruit_GFX/Adafruit_SSD1306.o
...
OBJECTS += ./mbed-os/features/FEATURE_BLE/source/Gap.o
...
OBJECTS += ./mbed-os/features/FEATURE_BLE/targets/TARGET_NORDIC/TARGET_NRF52/source/btle/btle.o
OBJECTS += ./mbed-os/features/FEATURE_BLE/targets/TARGET_NORDIC/TARGET_NRF52/source/btle/custom/custom_helper.o
OBJECTS += ./mbed-os/features/FEATURE_BLE/targets/TARGET_NORDIC/TARGET_NRF52/source/nRF5xCrypto.o
OBJECTS += ./mbed-os/features/FEATURE_BLE/targets/TARGET_NORDIC/TARGET_NRF52/source/nRF5xGap.o
OBJECTS += ./mbed-os/features/FEATURE_BLE/targets/TARGET_NORDIC/TARGET_NRF52/source/nRF5xGattServer.o
OBJECTS += ./mbed-os/features/FEATURE_BLE/targets/TARGET_NORDIC/TARGET_NRF52/source/nRF5xPalGattClient.o
OBJECTS += ./mbed-os/features/FEATURE_BLE/targets/TARGET_NORDIC/TARGET_NRF52/source/nRF5xPalSecurityManager.o
OBJECTS += ./mbed-os/features/FEATURE_BLE/targets/TARGET_NORDIC/TARGET_NRF52/source/nRF5xn.o
...
OBJECTS += ./mbed-os/features/cellular/framework/targets/GEMALTO/CINTERION/GEMALTO_CINTERION_CellularNetwork.o
OBJECTS += ./mbed-os/features/cellular/framework/targets/GEMALTO/CINTERION/GEMALTO_CINTERION_CellularStack.o
OBJECTS += ./mbed-os/features/cellular/framework/targets/GEMALTO/CINTERION/GEMALTO_CINTERION_Module.o
...
OBJECTS += ./mbed-os/features/cellular/framework/targets/MultiTech/DragonflyNano/PPP/SARA4_PPP_CellularPower.o
...
OBJECTS += ./mbed-os/features/cellular/framework/targets/QUECTEL/BG96/QUECTEL_BG96_CellularSIM.o
...
OBJECTS += ./mbed-os/features/cellular/framework/targets/QUECTEL/UG96/QUECTEL_UG96_CellularNetwork.o
OBJECTS += ./mbed-os/features/cellular/framework/targets/QUECTEL/UG96/QUECTEL_UG96_CellularPower.o
...
OBJECTS += ./mbed-os/features/cellular/framework/targets/UBLOX/AT/UBLOX_AT_CellularPower.o
...
OBJECTS += ./mbed-os/features/nanostack/sal-stack-nanostack/source/6LoWPAN/Thread/thread_dhcpv6_client.o
...
OBJECTS += ./mbed-os/features/netsocket/EMACMemoryManager.o
...
INCLUDE_PATHS += -I../.
INCLUDE_PATHS += -I.././Adafruit_GFX
INCLUDE_PATHS += -I.././Adafruit_GFX/fonts
...
INCLUDE_PATHS += -I.././mbed-os/features/FEATURE_BLE/targets/TARGET_NORDIC/TARGET_NRF52
INCLUDE_PATHS += -I.././mbed-os/features/FEATURE_BLE/targets/TARGET_NORDIC/TARGET_NRF52/source
INCLUDE_PATHS += -I.././mbed-os/features/FEATURE_BLE/targets/TARGET_NORDIC/TARGET_NRF52/source/btle
INCLUDE_PATHS += -I.././mbed-os/features/FEATURE_BLE/targets/TARGET_NORDIC/TARGET_NRF52/source/btle/custom
INCLUDE_PATHS += -I.././mbed-os/features/FEATURE_BLE/targets/TARGET_NORDIC/TARGET_NRF52/source/common
...
INCLUDE_PATHS += -I.././mbed-os/targets/TARGET_NORDIC/TARGET_NRF5x/TARGET_NRF52/TARGET_MCU_NRF52832/TARGET_NRF52832_MDK
...
PREPROC = arm-none-eabi-cpp -E -P -Wl,--gc-sections -Wl,--wrap,main -Wl,--wrap,_malloc_r -Wl,--wrap,_free_r -Wl,--wrap,_realloc_r -Wl,--wrap,_memalign_r -Wl,--wrap,_calloc_r -Wl,--wrap,exit -Wl,--wrap,atexit -Wl,-n -mcpu=cortex-m4 -mthumb -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -DSOFTDEVICE_PRESENT=1 -DMBED_APP_START=0x23000 -DMBED_APP_SIZE=0x5d000
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1551232715.76
...
C_FLAGS += -DBOOTLOADER_ADDR=0x0
C_FLAGS += -DBOOTLOADER_SIZE=0x23000
...
CXX_FLAGS += -DTARGET_NRF52832_MDK
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1551232715.76
...
CXX_FLAGS += -DBOOTLOADER_ADDR=0x0
CXX_FLAGS += -DBOOTLOADER_SIZE=0x23000
...
ASM_FLAGS += -I../.
ASM_FLAGS += -I.././Adafruit_GFX
ASM_FLAGS += -I.././Adafruit_GFX/fonts
ASM_FLAGS += -I.././mbed-os
...
ASM_FLAGS += -I.././mbed-os/features/FEATURE_BLE/targets/TARGET_NORDIC/TARGET_NRF52
ASM_FLAGS += -I.././mbed-os/features/FEATURE_BLE/targets/TARGET_NORDIC/TARGET_NRF52/source
ASM_FLAGS += -I.././mbed-os/features/FEATURE_BLE/targets/TARGET_NORDIC/TARGET_NRF52/source/btle
ASM_FLAGS += -I.././mbed-os/features/FEATURE_BLE/targets/TARGET_NORDIC/TARGET_NRF52/source/btle/custom
ASM_FLAGS += -I.././mbed-os/features/FEATURE_BLE/targets/TARGET_NORDIC/TARGET_NRF52/source/common
...
ASM_FLAGS += -I.././mbed-os/targets/TARGET_NORDIC/TARGET_NRF5x/TARGET_NRF52/TARGET_MCU_NRF52832/TARGET_NRF52832_MDK
...
LD_FLAGS :=-Wl,--gc-sections -Wl,--wrap,main -Wl,--wrap,_malloc_r -Wl,--wrap,_free_r -Wl,--wrap,_realloc_r -Wl,--wrap,_memalign_r -Wl,--wrap,_calloc_r -Wl,--wrap,exit -Wl,--wrap,atexit -Wl,-n -mcpu=cortex-m4 -mthumb -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -DSOFTDEVICE_PRESENT=1 -DMBED_APP_START=0x23000 -DMBED_APP_SIZE=0x5d000 
